...
/**
 * @author: mlsnatalie
 * @date: 2021/5/10 2:49 PM
 * @UpdateDate: 2021/5/10 2:49 PM
...
public class MyIntentService extends IntentService {
    ...
    public static MyIntentService.UpdateUI updateUI;


    public static void setUpdateUI(MyIntentService.UpdateUI updateUIInterface){
